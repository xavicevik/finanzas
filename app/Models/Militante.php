...
class Militante extends Authenticatable implements Auditable
{
    ...
    protected $fillable = [
        ...
        'idsolicitudaval', 'cccreated_at', 'ccupdated_at'
    ];
    ...
    public function solicitud() {
        return $this->belongsTo(Solicitudaval::class, 'idsolicitudaval');
    }
    ...
    public function historialaval() {
        return $this->hasMany(Historialaval::class, 'idmilitante');
    }
